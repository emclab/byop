...
describe PurchasingLogsController do
  ...
  describe "index" do
    it "should allow for index" do
      ...
      purchasing = FactoryGirl.create(:purchasing, :input_by_id => u.id)
  ...
  describe "GET 'new'" do
    it "should be successful for mech eng" do
      ...
      purchasing = FactoryGirl.create(:purchasing)
      log = FactoryGirl.attributes_for(:purchasing_log, :purchasing_id => purchasing.id)      
  ...
  describe "'create'" do
    it "should be successful for comp_sec" do
      ...
      response.should redirect_to purchasing_purchasing_logs_path(purchasing)
    end
