...
describe CustomersController do
  ...
  describe "'index'" do
    it "should be success" do
      ...
      log = FactoryGirl.create(:comm_log, :customer_id => cust.id)
      get 'index'
  ...
  describe "'create'" do
    it "should be success for ceo" do
      session[:ceo] = true
      session[:user_id] = 1
      cust = FactoryGirl.attributes_for(:customer)
      lambda do
    ...
    it "should redirect to 'new' for wrong data" do
      session[:ceo] = true
      session[:user_id] = 1
      cust = FactoryGirl.attributes_for(:customer, :name => nil)
      get 'create', :customer => cust
  ...
  describe "'show'" do
    ...
    it "be success for vp_eng" do
      ...
      cust = FactoryGirl.create(:customer, :input_by_id => u.id)
      get 'show', :id => cust.id
      response.should be_success
    end
  end
