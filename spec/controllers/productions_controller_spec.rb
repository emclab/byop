...
describe ProductionsController do
  ...
  describe "'index'" do
    it "returns http success for eng" do
      ...
      prod = Factory(:production, :project_id => proj.id)
  ...
  describe "'new'" do
    it "reject those without rights" do
      proj = Factory(:project)
      prod = Factory.attributes_for(:production, :project_id => proj.id)
  ...
  describe "'create'" do
    ...
    it "should OK for vp_eng and increase record count by 1 " do
      ...
      u = Factory(:user)
      proj = Factory(:project)
      prod = Factory.attributes_for(:production, :input_by_id => u.id, :project_id => proj.id) 
      lambda do
        get 'create', :project_id => proj.id, :production => prod
    ...
    it "should redirec to 'new' for data error and no record count increase" do
      ...
      u = Factory(:user)
      proj = Factory(:project)
      prod = Factory.attributes_for(:production, :name => nil, :input_by_id => u.id, :project_id => proj.id) 
      lambda do
        get 'create', :project_id => proj.id, :production => prod
  ...
  describe "GET 'edit'" do
    ...
    it "should OK for vp eng" do
      ...
      session[:vp_eng] = true
      u = Factory(:user)
      prod = Factory(:production, :input_by_id => u.id, :project_id => proj.id)
      get 'edit', :project_id => proj.id, :id => prod.id
      response.should be_success
    end
  end
