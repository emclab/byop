...
describe SuppliersController do
  ...
  describe "'index'" do
    it "returns http success for anyone" do
      supl = FactoryGirl.create(:supplier)
      get 'index'
  ...
  describe "'new'" do
    it "reject those without rights" do
      supl = FactoryGirl.attributes_for(:supplier)
      get 'new'
  ...
  describe "'create'" do
    ...
    it "should OK for pur_eng and increase record count by 1 for pur eng" do
      ...
      supl = FactoryGirl.attributes_for(:supplier, :input_by_id => u.id) 
      lambda do
    ...
    it "should redirec to 'new' for data error and no record count increase" do
      session[:pur_eng] = true
      u = FactoryGirl.create(:user)
      supl = FactoryGirl.attributes_for(:supplier, :name => nil, :input_by_id => u.id) 
      lambda do
        get 'create', :supplier => supl
  ...
  describe "GET 'edit'" do
    ...
    it "should OK for vp_eng" do
      session[:vp_eng] = true
      u = FactoryGirl.create(:user)
      supl = FactoryGirl.create(:supplier, :input_by_id => u.id)
      get 'edit', :id => supl.id
      response.should be_success
    end
  end
