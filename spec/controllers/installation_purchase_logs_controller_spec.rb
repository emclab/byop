...
describe InstallationPurchaseLogsController do
  ...
  describe "'new'" do
    it "should be successful for inst eng" do
      ...
      installation_purchase = FactoryGirl.create(:installation_purchase, :installation_id => installation.id)
      log = FactoryGirl.attributes_for(:installation_purchase_log, :installation_purchase_id => installation_purchase.id)      
