...
describe SrcPlantsController do
  ...
  describe "'index'" do
    it "returns http success for anyone" do
      plant = FactoryGirl.create(:src_plant)
      get 'index'
  ...
  describe "'new'" do
    it "reject those without rights" do
      plant = FactoryGirl.attributes_for(:src_plant)
      get 'new'
  ...
  describe "'create'" do
    ...
    it "should OK for src_eng and increase record count by 1 for src plant" do
      ...
      plant = FactoryGirl.attributes_for(:src_plant, :input_by_id => u.id) 
      lambda do
    ...
    it "should redirec to 'new' for data error and no record count increase" do
      session[:src_eng] = true
      u = FactoryGirl.create(:user)
      plant = FactoryGirl.attributes_for(:src_plant, :name => nil, :input_by_id => u.id) 
      lambda do
        get 'create', :src_plant => plant
  ...
  describe "GET 'edit'" do
    ...
    it "should OK for vp_eng" do
      session[:vp_eng] = true
      u = FactoryGirl.create(:user)
      plant = FactoryGirl.create(:src_plant, :input_by_id => u.id)
      get 'edit', :id => plant.id
      response.should be_success
    end
  end
