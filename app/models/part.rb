...
class Part < ActiveRecord::Base
  attr_accessible :in_qty, :unit, :name, :spec, :in_date, :stock_qty,:manufacturer, :inspection, :note, :storage_location, :supplier,
                  :as => :role_new
  attr_accessible :unit, :name, :spec, :stock_qty,:manufacturer, :inspection, :note, :storage_location, :supplier, :in_date,
                  :as => :role_update
